...
import sys
sys.path.append("src/navigation_bot_06/launch") 
from globals import *

def generate_launch_description():
    # Now in globals.py
    # package_name = 'navigation_bot_06'
    ...
    rviz_timer_action = launch.actions.TimerAction( period=5.0, actions=[ rviz_cmd ])
