...
def generate_launch_description():
    ...
    arm_core_file_name = get_package_share_directory('arm_02') + '/description/arm.urdf.xacro'
    ...
    world = os.path.join(get_package_share_directory('arm_02'), '../worlds', world_file_name)
    ...
    rviz_config_file = get_package_share_directory('arm_02') + "/rviz/armA.rviz"
