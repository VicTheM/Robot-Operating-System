...
import sys
sys.path.append("src/debugging/launch") 
from globals import *
...
def generate_launch_description():
    ...
    # def_keepout_mask_path declared in globals.py
    ...
    bringup_cmd_group = GroupAction([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(def_launch_dir, 'slam_launch.py')),
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(def_launch_dir,
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(def_launch_dir, 'navigation_launch.py')),
            condition=IfCondition(PythonExpression(['not ', slam])),
            launch_arguments={
                'namespace': namespace,
                'use_sim_time': use_sim_time,
