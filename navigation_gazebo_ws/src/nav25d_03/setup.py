...
setup(
    ...
    entry_points={
        'console_scripts': [
            'waypoint_follower = nav25d_03.01_waypoint_follower:main',
            'nav_through_poses = nav25d_03.02_nav_through_poses:main',
            'charger_docking = nav25d_03.03_charger_docking:main',
            'charger_docking_with_obstacles = nav25d_03.04_charger_docking_with_obstacles:main',
            
            'coordinator =                  nav25d_03.Coordinator:main',
            'path_follower =                nav25d_03.PathFollower:main',
            'global_planner_straight_line = nav25d_03.GlobalPlannerStraightLine:main',
            'a_star_graph =                 nav25d_03.a_star_graph:main',
            'global_planner_a_star_graph =  nav25d_03.GlobalPlannerAStarGraph:main',
            'global_planner_a_star_grid =   nav25d_03.GlobalPlannerAStarGrid:main',
            'img_layer_manager =            nav25d_03.ImgLayerManager:main',

            'kalman_nav =                   nav25d_03.KalmanNav:main',
            'navigation =                   nav25d_03.Navigation:main',
        ],
    },
)
