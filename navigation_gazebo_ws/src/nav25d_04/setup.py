...
setup(
    ...
    entry_points={
        'console_scripts': [
            'waypoint_follower = nav25d_04.01_waypoint_follower:main',
            'nav_through_poses = nav25d_04.02_nav_through_poses:main',
            'charger_docking = nav25d_04.03_charger_docking:main',
            'charger_docking_with_obstacles = nav25d_04.04_charger_docking_with_obstacles:main',
            
            'coordinator =                  nav25d_04.Coordinator:main',
            'path_follower =                nav25d_04.PathFollower:main',
            'global_planner_straight_line = nav25d_04.GlobalPlannerStraightLine:main',
            'a_star_graph =                 nav25d_04.a_star_graph:main',
            'global_planner_a_star_graph =  nav25d_04.GlobalPlannerAStarGraph:main',
            'global_planner_a_star_grid =   nav25d_04.GlobalPlannerAStarGrid:main',
            'img_layer_manager =            nav25d_04.ImgLayerManager:main',

            'kalman_nav =                   nav25d_04.KalmanNav:main',
            'navigation =                   nav25d_04.Navigation:main',
        ],
    },
)
