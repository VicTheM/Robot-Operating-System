...
setup(
    ...
    entry_points={
        'console_scripts': [
            'waypoint_follower = multi_bot_nav_01.01_waypoint_follower:main',
            'nav_through_poses = multi_bot_nav_01.02_nav_through_poses:main',
            'charger_docking = multi_bot_nav_01.03_charger_docking:main',
            'charger_docking_with_obstacles = multi_bot_nav_01.04_charger_docking_with_obstacles:main',
            
            'coordinator =                  multi_bot_nav_01.Coordinator:main',
            'path_follower =                multi_bot_nav_01.PathFollower:main',
            'global_planner_straight_line = multi_bot_nav_01.GlobalPlannerStraightLine:main',
        ],
    },
)
