...
ros_shared_path = '/opt/ros/galactic/share/'

package_name = 'navigation_bot_09'
global bringup_dir
...
global maps_path
maps_path = os.path.join(bringup_dir, '../maps', 'map.yaml')

global keepout_mask_path
keepout_mask_path = os.path.join(bringup_dir, '../maps', 'keepout_mask.yaml')
