...
import sys
sys.path.append("src/multi_bot_nav_03/launch") 
from globals import *
...
def generate_launch_description():
    robots = [
        # Uncomment to place robot on the road
        # {'name': '', 'x_pos': 5.78, 'y_pos': 1.12, 'z_pos': 1.0, 
        #    "color_name" : "Green", "color_rgb" : "0 1 0 1"},

        # Uncomment to place robot off-road
        {'name': '', 'x_pos': 5.5, 'y_pos': 3.5, 'z_pos': 1.0, 
           "color_name" : "Green", "color_rgb" : "0 1 0 1"},


        # {'name': 'robot1', 'x_pos': 5.78, 'y_pos': 1.12, 'z_pos': 0.01,
        #     "color_name" : 'Yellow', "color_rgb" : "1 1 0 1"},
        # {'name': 'robot2', 'x_pos': 1.78, 'y_pos': -3.05, 'z_pos': 0.01,
