...
class GlobalPlannerStraightLine(Node):
    ...
    def __init__(self, robot_name):
        ...
        self.plan_publisher = self.create_publisher(Path, self.strSlashRobotName + "/plan/straight_line", 1)

        self.make_plan_service = self.create_service(GetPlan, self.strSlashRobotName + "/plan/straight_line", 
            self.make_plan_callback)
    
        self.get_plan_client = self.create_client(GetPlan, self.strSlashRobotName + "/plan/straight_line")
    ...
    def getPath(self, start, goal):
        print("*** GlobalPlannerStraightLine.getPath()")
