...
# TBE: in future, also copy resources, like images for aruco markers
...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'description', 'meshes', 'a0912_blue'), 
            glob(os.path.join('description','meshes','a0912_blue', '*.stl'))),
    ...
    entry_points={
        'console_scripts': [
                'trajectory_points_act_server = arm_01.basic_trajectory_action_service:main',
        ],
    },
)
