...
class BasicNavigator(Node):
    def __init__(self, strRobotName = ""):
        ...
        self.initial_pose.header.frame_id = self.strRobotNameSlash + 'map'
        ...
        # Comment the following line for Foxy, uncomment for Galactic:
        self.nav_through_poses_client = ActionClient(self, NavigateThroughPoses, 
            self.strRobotNameSlash + 'navigate_through_poses')
            
        self.nav_to_pose_client = ActionClient(self, NavigateToPose, 
            self.strRobotNameSlash + 'navigate_to_pose')
        ...
        self.localization_pose_sub = self.create_subscription(PoseWithCovarianceStamped,
            self.strSlashRobotName + '/amcl_pose', self._amclPoseCallback, self.amcl_pose_qos)
        ...
        # self.get_straight_line_path_planner_client = self.create_client(GetPlan, '/plan')
    ...
    def getStraightLinePath(self, start, goal):
        ...
        while not self.nav_to_pose_client.wait_for_server(timeout_sec=1.0):
            print("### 'GlobalPlannerStraightLine' service not available, waiting...")
        ...
        future = self.get_straight_line_path_planner_client.call_async(request)
    ...
    def waitForNodesToStart(self):
        ...
        lifecycle_nodes = [
            self.strRobotNameSlash + 'amcl', 
            #'ekf_filter_node',
            self.strRobotNameSlash + 'controller_server',
            self.strRobotNameSlash + 'planner_server',
            self.strRobotNameSlash + 'recoveries_server',
            self.strRobotNameSlash + 'bt_navigator',
            self.strRobotNameSlash + 'waypoint_follower'
        ]
