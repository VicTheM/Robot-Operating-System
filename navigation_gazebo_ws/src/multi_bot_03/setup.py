...
setup(
    ...
    entry_points={
        'console_scripts': [
            'waypoint_follower = multi_bot_03.01_waypoint_follower:main',
            'nav_through_poses = multi_bot_03.02_nav_through_poses:main',
            'charger_docking = multi_bot_03.03_charger_docking:main',
            'charger_docking_with_obstacles = multi_bot_03.04_charger_docking_with_obstacles:main',
        ],
    },
)
