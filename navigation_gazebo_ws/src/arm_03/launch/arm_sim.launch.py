...
def generate_launch_description():
    ...
    arm_core_file_name = get_package_share_directory('arm_03') + '/description/arm.urdf.xacro'
    ...
    # Gazebo   
    world_file_name = 'gripper_bench.sdf'
    world = os.path.join(get_package_share_directory('arm_03'), '../worlds', world_file_name)
    ...
    # arm_controller_yaml = os.path.join(get_package_share_directory('arm_03'),
    #                                'config', 'armA_controller.yaml')

    # joint_trajectory_controller_arm = ExecuteProcess( 
    #     cmd=['ros2', 'control', 'load_controller', '--set-state', 'start', 
    #         '-c', arm_controller_yaml, 'joint_trajectory_controller_arm'], 
    #     output='screen')
    ...
    rviz_config_file = get_package_share_directory('arm_03') + "/rviz/armA.rviz"
    ...
    # grasping_controller_node = Node(
    #     package='arm_03',
    #     executable='grasping_controller',
    #     name='grasping_controller_node',
    #     output='screen'
    # )

    return LaunchDescription([robot_state_publisher, spawn_entity, 
        gazebo_node, joint_state_broadcaster, 
        joint_trajectory_controller,
        rviz_node, 
        #joint_state_publisher_gui,
        gazebo_exit_event_handler, rviz_exit_event_handler,
        #grasping_controller_node]
    ])