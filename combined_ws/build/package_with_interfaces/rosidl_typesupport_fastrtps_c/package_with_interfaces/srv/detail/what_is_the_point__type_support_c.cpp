...
#include "package_with_interfaces/srv/detail/what_is_the_point__rosidl_typesupport_fastrtps_c.h"
...
#include "package_with_interfaces/msg/detail/amazing_quote__functions.h"  // quote
...
using _WhatIsThePoint_Request__ros_msg_type = package_with_interfaces__srv__WhatIsThePoint_Request;
  ...
  // Field name: quote
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, package_with_interfaces, msg, AmazingQuote
      )()->data);
...
size_t get_serialized_size_package_with_interfaces__srv__WhatIsThePoint_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _WhatIsThePoint_Request__ros_msg_type * ros_message = static_cast<const _WhatIsThePoint_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_package_with_interfaces__msg__AmazingQuote(
...
static uint32_t _WhatIsThePoint_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_package_with_interfaces__srv__WhatIsThePoint_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_with_interfaces
size_t max_serialized_size_package_with_interfaces__srv__WhatIsThePoint_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: quote
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_package_with_interfaces__msg__AmazingQuote(
  ...
  if (is_plain) {
    ...
    using DataType = package_with_interfaces__srv__WhatIsThePoint_Request;
    is_plain =
      (
...
static size_t _WhatIsThePoint_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_package_with_interfaces__srv__WhatIsThePoint_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_with_interfaces, srv, WhatIsThePoint_Request)() {
...
using _WhatIsThePoint_Response__ros_msg_type = package_with_interfaces__srv__WhatIsThePoint_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_with_interfaces
size_t get_serialized_size_package_with_interfaces__srv__WhatIsThePoint_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _WhatIsThePoint_Response__ros_msg_type * ros_message = static_cast<const _WhatIsThePoint_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_package_with_interfaces__srv__WhatIsThePoint_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_package_with_interfaces
size_t max_serialized_size_package_with_interfaces__srv__WhatIsThePoint_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = package_with_interfaces__srv__WhatIsThePoint_Response;
    is_plain =
      (
...
static size_t _WhatIsThePoint_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_package_with_interfaces__srv__WhatIsThePoint_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_with_interfaces, srv, WhatIsThePoint_Response)() {
...
// already included above
// #include "package_with_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "package_with_interfaces/srv/what_is_the_point.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_with_interfaces, srv, WhatIsThePoint)() {
