...
{
  new (message_memory) package_with_interfaces::msg::AmazingQuote(_init);
}

void AmazingQuote_fini_function(void * message_memory)
{
  auto typed_message = static_cast<package_with_interfaces::msg::AmazingQuote *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AmazingQuote_message_member_array[3] = {
  {
    ...
    offsetof(package_with_interfaces::msg::AmazingQuote, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(package_with_interfaces::msg::AmazingQuote, quote),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(package_with_interfaces::msg::AmazingQuote, philosopher_name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AmazingQuote_message_members = {
  ...
  3,  // number of fields
  sizeof(package_with_interfaces::msg::AmazingQuote),
...
get_message_type_support_handle<package_with_interfaces::msg::AmazingQuote>()
{
  return &::package_with_interfaces::msg::rosidl_typesupport_introspection_cpp::AmazingQuote_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, package_with_interfaces, msg, AmazingQuote)() {
  return &::package_with_interfaces::msg::rosidl_typesupport_introspection_cpp::AmazingQuote_message_type_support_handle;
}
